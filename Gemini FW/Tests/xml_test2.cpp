...
{
	XMLDocument doc;
	doc.LoadFile( "../TinyXml/resources/dream.xml" );
...
using namespace tinyXML2_test2;

int tinyXML2_main2( int argc, const char ** argv )
{
		...
		_CrtMemCheckpoint( &startMemState );
			...
			mkdir( "../TinyXml/resources/out/" );
                #else
                	_mkdir( "../TinyXml/resources/out/" );
                #endif
	#else
		mkdir( "../TinyXml/resources/out/", S_IRWXU | S_IRWXG | S_IROTH | S_IXOTH);
	#endif
	...
	FILE* fp = fopen( "./../TinyXml/resources/dream.xml", "r" );
	if ( !fp ) {
	...
	}
	{
		...
		doc->SaveFile( "./../TinyXml/resources/out/pretty.xml" );
		doc->SaveFile( "./../TinyXml/resources/out/compact.xml", true );
		delete doc;
	}
	{
		// Test: Dream
		...
		doc.SaveFile( "../TinyXml/resources/out/dreamout.xml" );
		doc.PrintError();
		...
		XMLDocument doc2;
		doc2.LoadFile( "../TinyXml/resources/out/dreamout.xml" );
	...
	{
		XMLDocument doc;
		doc.LoadFile( "../TinyXml/resources/utf8test.xml" );
		...
		doc.SaveFile( "../TinyXml/resources/out/utf8testout.xml" );

		// Check the round trip.
		int okay = 0;

		FILE* saved  = fopen( "../TinyXml/resources/out/utf8testout.xml", "r" );
		FILE* verify = fopen( "../TinyXml/resources/utf8testverify.xml", "r" );
...

	{
		...
		FILE* textfile = fopen( "../TinyXml/resources/out/textfile.txt", "w" );
		if ( textfile )
		{
        ...
        textfile = fopen( "../TinyXml/resources/out/textfile.txt", "r" );
...

	{
		...
		XMLDocument doc;
		doc.Parse( doctype );
		doc.SaveFile( "../TinyXml/resources/out/test7.xml" );
		doc.DeleteChild( doc.RootElement() );
		doc.LoadFile( "../TinyXml/resources/out/test7.xml" );
		doc.Print();
	...
	{
		XMLDocument doc;
		XMLError error = doc.LoadFile( "../TinyXml/resources/empty.xml" );
...

	{
        ...
        static const char* xml_bom_preservation  = "\xef\xbb\xbf<element/>\n";
        {
			...
			doc.SaveFile( "../TinyXml/resources/bomtest.xml" );
        }
		{
			XMLDocument doc;
			doc.LoadFile( "../TinyXml/resources/bomtest.xml" );
